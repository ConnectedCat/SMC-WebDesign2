...
let fetchRoverImage = function(){
    ...
    fetch(imgURL).
        ...
        then(function(data){
            ...
            let title = document.createElement('h3');
            title.innerText = "Image from " + dateURL;
            roverImageDisplay.appendChild(title);
            ...
            description.innerText = "Image captured by Mars rover Curiosity.";
            roverImageDisplay.appendChild(description);
        })
